...
On Linux, download and install the appropriate package for your platform:
  ...
  * [Debian/Ubuntu AMD64 .deb](https://github.com/fhunleth/fwup/releases/download/v0.13.0/fwup_0.13.0_amd64.deb)
  * [Raspbian armhf .deb](https://github.com/fhunleth/fwup/releases/download/v0.13.0/fwup_0.13.0_armhf.deb)
  * [RedHat/CentOS x86\_64 .rpm](https://github.com/fhunleth/fwup/releases/download/v0.13.0/fwup-0.13.0-1.x86_64.rpm)
...
Alternatively, download the [fwup executable](https://github.com/fhunleth/fwup/releases/download/v0.13.0/fwup.exe)
and place it in your path.

If you're using another platform or prefer to build it yourself, download the
latest [source code release](https://github.com/fhunleth/fwup/releases/download/v0.13.0/fwup-0.13.0.tar.gz) or clone this repository. Then read one of the following files:
